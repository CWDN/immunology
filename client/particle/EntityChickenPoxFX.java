...
public class EntityChickenPoxFX extends EntityFX
{
	...
	{        
        ...
        GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, ModLoader.getMinecraftInstance().renderEngine.getTexture("/mods/Immunology/textures/particles/chickpox.png"));
        ...
        float f8 = (float)(this.particleTextureIndexY / 16) / 16F;
