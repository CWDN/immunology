...
public class ImmunologyFont
{
    ...
    public ImmunologyFont(GameSettings par1GameSettings, String par2Str, RenderEngine par3RenderEngine, boolean par4)
    {
    ...
    private float renderDefaultChar(int par1, boolean par2)
    {
        ...
        float f3 = (float)this.charWidth[par1];
